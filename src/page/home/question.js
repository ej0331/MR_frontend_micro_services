...
import Modal from "../../component/chart/homequestion";
import "./table.css";
import ExcelJS from "exceljs";
import { getQuantityLimitedPracticeChartData } from "../../api/quantityLimitedPractice";
import { QuantityLimitedPracticelist } from "../../api/excel";
...
const QuestionTab = ({
  ...
  const fetchChartData = async (id) => {
    try {
      const res = await getQuantityLimitedPracticeChartData(
        id,
        startDate,
        endDate
      );
  ...
  const handleDownload = async () => {
    try {
      const res = await QuantityLimitedPracticelist();
