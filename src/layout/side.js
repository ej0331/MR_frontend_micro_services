        ...
        <div className="">
          <ul className="space-y-2">
            {menuItems.map((item, index) => (
              <li
                key={index}
                className={`px-6 py-2 w-40  rounded ${
            ...
            {/* <li className="hover:bg-secondcolor px-5 py-2 rounded">學生練習</li>
          <li className="hover:bg-secondcolor px-5 py-2 rounded">學生測驗</li>
          <li className="hover:bg-secondcolor px-5 py-2 rounded">學生帳號</li> */}
